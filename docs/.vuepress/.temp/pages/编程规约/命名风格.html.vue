...
<li>【强制】代码中的命名严禁使用拼音与英文混合的方式，更不允许直接使用中文的方式。
...
<br><span style="color:red">反例</span>：baoxian/投保人/ int 计数器 = 3</li>
<li>【强制】类名使用<code v-pre>UpperCamelCase</code>风格，但以下情形例外： DTO / VO 等。
...
<br><span style="color:green">正例</span>：AbstractTranslator实现 Translatable。</li>
<li>【参考】枚举类名建议带上Enum后缀，枚举成员名称需要全大写，单词间用下划线隔开。
