<template><div><h2 id="三-sql语句" tabindex="-1"><a class="header-anchor" href="#三-sql语句"><span>(三) SQL语句</span></a></h2>
<ol>
...
<ol start="4">
<li>【强制】使用<code v-pre>ISNULL()</code>来判断是否为NULL值。 说明：NULL与任何值的直接比较都为NULL。<br>
1） <code v-pre>NULL&lt;&gt;NULL</code>的返回结果是NULL，而不是<code v-pre>false</code>。<br>
2） <code v-pre>NULL=NULL</code>的返回结果是NULL，而不是<code v-pre>true</code>。<br>
3） <code v-pre>NULL&lt;&gt;1</code>的返回结果是NULL，而不是<code v-pre>true</code>。</li>
