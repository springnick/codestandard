<template><div><h2 id="二-索引规约" tabindex="-1"><a class="header-anchor" href="#二-索引规约"><span>(二) 索引规约</span></a></h2>
<ol>
...
<br><span style="color:green">正例</span>：先快速定位需要获取的id段，然后再关联：</li>
</ol>
...
<br><span style="color:orange">说明</span>：<br>
1）consts 单表中最多只有一个匹配行（主键或者唯一索引），在优化阶段即可读取到数据。<br>
